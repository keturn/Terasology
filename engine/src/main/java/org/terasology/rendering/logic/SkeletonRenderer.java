...
public class SkeletonRenderer extends BaseComponentSystem implements RenderSystem, UpdateSubscriberSystem {
    ...
    public void renderOpaque() {
        ...
        for (EntityRef entity : entityManager.getEntitiesWith(SkeletalMeshComponent.class, LocationComponent.class)) {
            ...
            skeletalMesh.material.setMatrix4("projectionMatrix", worldRenderer.getActiveCamera().getJomlProjectionMatrix());
    ...
    public void renderOverlay() {
        if (config.getRendering().getDebug().isRenderSkeletons()) {
            ...
            material.setMatrix4("projectionMatrix", worldRenderer.getActiveCamera().getJomlProjectionMatrix());
            Vector3f worldPos = new Vector3f();
